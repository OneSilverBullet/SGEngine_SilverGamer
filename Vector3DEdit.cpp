...
Vector3DEdit::Vector3DEdit(QString title, Qt::Orientation orientation, QString label0, QString label1, QString label2, float minimum, float maximum, int decimals, QWidget * parent)
{
	for (int i = 0; i < 3; ++i)
	{
		m_labels[i] = new QLabel(this);
...
void Vector3DEdit::floatEditValueEdited(float value)
{
